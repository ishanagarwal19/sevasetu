...
const AdminContextProvider = (props) => {
    ...
    // Function to change hospital availability using API
    const changeHospitalAvailability = async (hospitalId) => {
        try {
            const { data } = await axios.post(backendUrl + '/api/admin/change-hospital-availability', { hospitalId }, { headers: { aToken } })
            if (data.success) {
                toast.success(data.message)
                getAllHospitals()
            } else {
